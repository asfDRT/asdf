...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="h1_bro">Регистрация</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <form method="POST" action="registration.php">
                    ...
                    <div class="row form_reg"><input class="form" type="password" name="pass" placeholder="Password"></div>
                    <button type="sumbit" class="btn_green btn_reg" name="submit">Продолжить</button>
                </form>    
            </div>
        </div>
    </div>
...
if (isset($_POST['submit'])){
    ...
    if (!$email || !$username || !$pass) die("Пожалуйства введите все заначения!");
